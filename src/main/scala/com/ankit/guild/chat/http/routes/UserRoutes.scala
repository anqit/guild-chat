...
class UserRoutes(val userService: UserService)(implicit marshaller: ToResponseMarshaller[User], unmarshaller: FromRequestUnmarshaller[User]) extends RouteProvider with Directives {
